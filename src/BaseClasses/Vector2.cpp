 ...
 *   @details Returns true or false depending on the vector is equal to (0, 0) or not.
 *   @return  Vector2
 */
 ...
 *   @details Converts SFML's float-based vector value into our custom Vector2 class value.
 *   @return  Vector2
 */
...
/**
 *   @brief   Turns SFML vector to our own Vector2 variable.
 *   @details Converts SFML's integer-based vector value into our custom Vector2 class value.
 *   @return  Vector2
 */
 ...
 *   @details Returns the value of two vectors' x and y values being added together.
 *   @return  Vector2
 */
Vector2 Vector2::operator+(const Vector2& rhs)
{
 ...
 *   @details Returns the value of two vectors' x and y values being subtracted away from each other.
 *   @return  Vector2
 */
Vector2 Vector2::operator-(const Vector2& rhs)
{
